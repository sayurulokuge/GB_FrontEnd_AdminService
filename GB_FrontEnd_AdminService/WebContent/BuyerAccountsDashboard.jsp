...
<meta charset="ISO-8859-1">
	...
	<title>GadgetBadget Buyer Accounts</title>
        ...
        <div class="row row-cols-2 p-0 m-0 pageContent" >
	                    ...
	                    <ul>
	                        ...
	                        <li><a class="dropbtnAccounts" href="#"><i class="fas fa-id-card mr-3"></i>Accounts<span class="fas fa-sort-down Accounts-sp"></span></a>
	                            <ul class="dropContAccounts">
	                                <li><a href="http://localhost:8080/GB_FrontEnd_AdminService/InnovatorAccountsDashboard.jsp">Innovators</a></li>
	                                <li class="" style=" background-color: rgb(255, 255, 255 , 0.4); margin: 10px; border-radius: 5px;"><a href="http://localhost:8080/GB_FrontEnd_AdminService/BuyerAccountsDashboard.jsp">Buyers</a></li>
	                            </ul>
	                        </li>
            ...
            <div class="col-10 pl-0 pr-0 m-0 contentArea" style="width: 100%; position: relative; left: -2px;">
                ...
                <nav class="navbar-expand-lg  pl-4 p-0 d-flex justify-content-between" style="background-color: rgba(250, 68, 68 , 0.9); height: 70px;">
                    ...
                    <h1 class="navbar-brand mt-2" style="font-weight: bold; font-size: 30px;" ><i class="fas fa-id-card mr-3"></i>Buyer Accounts</h1>
